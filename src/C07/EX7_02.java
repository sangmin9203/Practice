...
public class EX7_02 {
	public static void main(String[] args) {
		EX7_01 s1 = new EX7_01(20);
		EX7_01 s2 = new EX7_01(20);
		EX7_01 s3 = new EX7_01(20);
		...
		System.out.println("집합 s2에 s3는 "+(s2.equalTo(s3)? "같습니다." : "같지 않습니다."));
		
		s3.unionOf(s1, s2); //s3 는 s1과 s2의 합집합
